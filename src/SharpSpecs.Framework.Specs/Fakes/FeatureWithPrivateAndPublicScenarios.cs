...
{
    public class FeatureWithPrivateAndPublicScenarios : FeatureWithPrivateAndPublicScenariosSteps
    {
        ...
        public Scenario third_scenario()
        {
            return Given(I_have_a_first_step)
                .When(I_have_a_second_step)
                .Then(I_have_a_third_step);
        ...
        public Scenario forth_scenario()
        {
            return Given(I_have_a_forth_step)
                .When(I_have_a_fifth_step)
                .Then(I_have_a_sixth_step);
    ...
    public class FeatureWithPrivateAndPublicScenariosSteps : Feature
    {
