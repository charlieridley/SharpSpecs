...
{
    /// <summary>
    /// Borrowed from Machine.Specification
    /// </summary>
...
{0}
        ...
        {
            if (condition)
                throw new SharpSpecsException("Should be [false] but is [true]");
        }

        public static void ShouldBeTrue(this bool condition)
        {
            if (!condition)
                throw new SharpSpecsException("Should be [true] but is [false]");
        }
        ...
        public static T ShouldEqual<T>(this T actual, T expected)
        {
            ...
            {
                throw new SharpSpecsException(string.Format("Should equal {0} but is {1}", expected.ToUsefulString(), actual.ToUsefulString()));
            }
        ...
        public static object ShouldNotEqual<T>(this T actual, T expected)
        {
            if (actual.SafeEquals(expected))
            {
                throw new SharpSpecsException(string.Format("Should not equal {0} but does: {1}", expected.ToUsefulString(), actual.ToUsefulString()));
            }
        ...
        public static void ShouldBeNull(this object anObject)
        {
            if (anObject != null)
            {
                throw new SharpSpecsException(string.Format("Should be [null] but is {0}", anObject.ToUsefulString()));
            }
        }
        ...
        public static void ShouldNotBeNull(this object anObject)
        {
            if (anObject == null)
            {
                throw new SharpSpecsException(string.Format("Should be [not null] but is [null]"));
            }
        }
        ...
        public static object ShouldBeTheSameAs(this object actual, object expected)
        {
            ...
            {
                throw new SharpSpecsException(string.Format("Should be the same as {0} but is {1}", expected, actual));
            }
        ...
        public static object ShouldNotBeTheSameAs(this object actual, object expected)
        {
            if (Object.ReferenceEquals(actual, expected))
            {
                throw new SharpSpecsException(string.Format("Should not be the same as {0} but is {1}", expected, actual));
            }
        ...
        {
            if (actual == null) throw new SharpSpecsException(string.Format("Should be of type {0} but is [null]", expected.GetType()));
            if (!expected.IsAssignableFrom(actual.GetType()))
            {
                throw new SharpSpecsException(string.Format("Should be of type {0} but is of type {1}", expected, actual.GetType()));
            }
        }
        ...
        public static void ShouldNotBeOfType(this object actual, Type expected)
        {
            ...
            {
                throw new SharpSpecsException(string.Format("Should not be of type {0} but is of type {1}", expected, actual.GetType()));
            }
        }
        ...
        public static void ShouldEachConformTo<T>(this IEnumerable<T> list, Func<T, bool> condition)
        {
            ...
            if (failingItems.Any())
            {
                ...
                throw new SharpSpecsException(message);
            }
        }
        ...
        public static void ShouldContain<T>(this IEnumerable<T> list, params T[] items)
        {
            ...
            if (noContain.Any())
            {
                throw new SharpSpecsException(string.Format(@"Should contain: {0} 
entire list: {1}
does not contain: {2}", items.EachToUsefulString(), list.EachToUsefulString(), noContain.EachToUsefulString()));
        ...
        public static void ShouldNotContain<T>(this IEnumerable<T> list, params T[] items)
        {
            ...
            if (contains.Any())
            {
                throw new SharpSpecsException(string.Format(@"Should not contain: {0} 
entire list: {1}
does contain: {2}", items.EachToUsefulString(), list.EachToUsefulString(), contains.EachToUsefulString()));
            }
        }

        private static SharpSpecsException NewException(string message, params object[] parameters)
        {
            if (parameters.Any())
            {
                return new SharpSpecsException(string.Format(message, parameters.Select(x => x.ToUsefulString()).Cast<object>().ToArray()));
            }
            return new SharpSpecsException(message);
        }
        ...
        public static void ShouldBeCloseTo(this float actual, float expected, float tolerance)
        {
            ...
            {
                throw new SharpSpecsException(string.Format("Should be within {0} of {1} but is {2}", tolerance.ToUsefulString(), expected.ToUsefulString(), actual.ToUsefulString()));
            }
        }
